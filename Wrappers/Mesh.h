...
namespace dmbrn
{
	...
	public:
		...
		// constructor
		Mesh(std::vector<Vertex>&& vertices, std::vector<uint16_t>&& indices, std::vector<Texture>&& textures, const PhysicalDevice& physical_device, const LogicalDevice& device,
